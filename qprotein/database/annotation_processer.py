...
if __name__ == '__main__':
    cazy_output = r'D:\subject\active\1-qProtein\data\manure\cazy_overview.txt'
    sql_db = r'D:\subject\active\1-qProtein\data\manure\qprotein_results.db'
    table_name = 'results_summary'
...
if __name__ == '__main__':
    dmnd_output = r'D:\subject\active\1-qProtein\data\manure\sprot_90.tab'
    sql_db = r'D:\subject\active\1-qProtein\data\manure\qprotein_results.db'
    table_name = 'results_summary'
...
if __name__ == '__main__':
    dmnd_output = r'D:\subject\active\1-qProtein\data\manure\trembl_90.tab'
    sql_db = r'D:\subject\active\1-qProtein\data\manure\qprotein_results.db'
    table_name = 'results_summary'
