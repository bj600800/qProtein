...
def calculate_weighted_sum_of_clusters(G):
    ...
    for component in connected_components:
        if len(component) > 1:
            ...
            cluster_res.append({key: value for key, value in pairs})
            # print(area)
    ...
    return round(weighted_sum, 2), round(max_cluster, 2), cluster_res
...
def analyze(atom_array):
    ...
    hydrophobic_cluster['cluster_res'] = cluster_res
...
if __name__ == '__main__':
    ...
    csv_path = r"D:\subject\active\1-qProtein\data\enzymes\GH10\3_StrucAnalyzing\hydrophobic.csv"
    all_ret = []
